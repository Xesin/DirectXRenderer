...
public:
	DescriptorHandle()
	{
		m_CpuHandle.ptr = (D3D12_GPU_VIRTUAL_ADDRESS)-1;
		m_GpuHandle.ptr = (D3D12_GPU_VIRTUAL_ADDRESS)-1;
	}
	...
	{
		if (m_CpuHandle.ptr != (D3D12_GPU_VIRTUAL_ADDRESS)-1)
			m_CpuHandle.ptr += OffsetScaledByDescriptorSize;
		if (m_GpuHandle.ptr != (D3D12_GPU_VIRTUAL_ADDRESS)-1)
	...
	bool IsNull() const { return m_CpuHandle.ptr == (D3D12_GPU_VIRTUAL_ADDRESS)-1; }
	bool IsShaderVisible() const { return m_GpuHandle.ptr != (D3D12_GPU_VIRTUAL_ADDRESS)-1; }
